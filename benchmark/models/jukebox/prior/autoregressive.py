...
from ..transformer.ops import filter_logits
from ..transformer.transformer import Transformer
from ..utils.torch_utils import empty_cache
...
class ConditionalAutoregressive2D(nn.Module):
    ...
    def forward(self, x, x_cond=None, y_cond=None, encoder_kv=None, fp16=False, loss_full=False,
        ...
        x = self.x_emb_dropout(x) + self.pos_emb_dropout(self.pos_emb()[:x_cond.shape[1]]) + x_cond # Pos emb and dropout
