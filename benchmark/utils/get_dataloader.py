...
from benchmark.tasks.MTT.MTT_dataset import (
    FeatureDataset as MTTFeatureDataset,
    AudioDataset as MTTAudioDataset,
)
from benchmark.tasks.GTZAN.GTZAN_dataset import (
    FeatureDataset as GTZANFeatureDataset,
    AudioDataset as GTZANAudioDataset,
)
from benchmark.tasks.VocalSet.VocalSetS_dataset import (
    FeatureDataset as VocalSetSFeatureDataset,
    AudioDataset as VocalSetSAudioDataset,
)
...
from benchmark.tasks.GS.GS_dataset import (
    FeatureDataset as GSFeatureDataset,
    AudioDataset as GSAudioDataset,
)
from benchmark.tasks.EMO.EMO_dataset import (
    FeatureDataset as EMOFeatureDataset,
    AudioDataset as EMOAudioDataset,
)
...
from benchmark.tasks.NSynth.NSynthI_dataset import (
    FeatureDataset as NSynthIFeatureDataset,
    AudioDataset as NSynthIAudioDataset,
)
from benchmark.tasks.NSynth.NSynthP_dataset import (
    FeatureDataset as NSynthPFeatureDataset,
    AudioDataset as NSynthPAudioDataset,
)
from benchmark.tasks.MTG.MTGGenre_dataset import (
    FeatureDataset as MTGGenreFeatureDataset,
)  # , AudioDataset as MTGGenreAudioDataset
from benchmark.tasks.MTG.MTGInstrument_dataset import (
    FeatureDataset as MTGInstrumentFeatureDataset,
)  # , AudioDataset as MTGInstrumentAudioDataset
from benchmark.tasks.MTG.MTGMood_dataset import (
    FeatureDataset as MTGMoodFeatureDataset,
)  # , AudioDataset as MTGMoodAudioDataset
from benchmark.tasks.MTG.MTGTop50_dataset import (
    FeatureDataset as MTGTop50FeatureDataset,
)  # , AudioDataset as MTGTop50AudioDataset
from benchmark.tasks.MUSDB18.MUSDB18_dataset import (
...
def get_audio_datasets(args):
    ...
    if args.dataset == "MUSDB18":
        ...
        valid_dataset = FixedSourcesTrackFolderDataset(
            split="valid", seq_duration=None, samples_per_track=1, **dataset_kwargs
        )
        test_dataset = FixedSourcesTrackFolderDataset(
            split="test", seq_duration=None, samples_per_track=1, **dataset_kwargs
        )
    else:
